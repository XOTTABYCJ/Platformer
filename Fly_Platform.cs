...
public class Fly_Platform : MonoBehaviour // Script for Move platform
{
    ...
    private void OnCollisionStay2D(Collision2D collision) // When the player comes into contact with the platform, it begins to move
    {
